...
const s = {
  app: { minHeight:"100vh", background:"#090909", color:"#e5e5e5", fontFamily:"system-ui,sans-serif", padding:16 },
  header: { display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:20, paddingBottom:16, borderBottom:"1px solid #1f1f1f" },
  ...
  pair: { fontWeight:700, fontSize:15, fontFamily:"monospace" },
...
export default function App() {
  const [trades, setTrades] = useState([
    { id:1, pair:"EUR/USD", direction:"Long", entry:"1.0820", exit:"1.0890", lots:"0.1", session:"London", strategy:"Trend Follow", notes:"Clean breakout.", date:"2026-04-21", status:"Closed" },
    { id:2, pair:"BTC/USD", direction:"Short", entry:"94200", exit:"93100", lots:"0.01", session:"New York", strategy:"Breakout", notes:"Rejection at resistance.", date:"2026-04-22", status:"Closed" },
    { id:3, pair:"GBP/JPY", direction:"Long", entry:"191.50", exit:"", lots:"0.05", session:"Asian", strategy:"Swing", notes:"Watching NY session.", date:"2026-04-28", status:"Open" },
  ]);
        ...
        <>
          ...
          {visible.length===0 && (
            <div style={{textAlign:"center",padding:"60px 0",color:"#333"}}>
              ...
              <div style={{marginTop:8,fontSize:13}}>No trades yet</div>
            </div>
          )}
              ...
              <div key={t.id} style={s.card}>
                <div style={s.row}>
                  ...
                  <div style={{textAlign:"right",minWidth:80}}>
                    {r ? (
                      <>
                        <div style={win?s.green:s.red}>{win?"+":""}{r.pnl}</div>
